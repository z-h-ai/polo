...
import type { SessionDraft, DraftAttachmentRef } from '@z-h-ai/shared/config'
...
import { extractWorkspaceSlugFromPath } from '@z-h-ai/shared/utils/workspace-slug'
import { DEFAULT_THINKING_LEVEL } from '@z-h-ai/shared/agent/thinking-levels'
