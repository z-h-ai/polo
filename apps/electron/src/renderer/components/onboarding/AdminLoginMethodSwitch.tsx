...
export function AdminLoginMethodSwitch({
  ...
  return (
    <button
      ...
      onClick={onSwitch}
      disabled={disabled}
      className="inline-flex min-h-[28px] w-full items-center justify-center whitespace-nowrap rounded-[8px] border border-border px-[12px] text-[12px] font-medium text-foreground transition-colors hover:bg-foreground-5 disabled:pointer-events-none disabled:opacity-50"
    >
      {t(target === "phone"
