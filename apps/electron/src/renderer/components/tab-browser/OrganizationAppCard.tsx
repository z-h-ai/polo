...
export function OrganizationAppCard({
  ...
  return (
    <article
      className={cn(
        'relative flex min-h-[176px] flex-col rounded-[17px] border border-foreground/10 bg-[var(--background-elevated)] p-[20px] shadow-xs transition-shadow hover:shadow-minimal',
