...
import type { WorkspaceInfo, Workspace, SessionMetadata, StoredAttachment as StoredAttachmentType } from '@polo-ai/core/types';
 ...
 * Mirrors the canonical type in `@polo-ai/messaging-gateway`.
 */
