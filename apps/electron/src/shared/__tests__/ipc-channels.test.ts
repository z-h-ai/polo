...
const EXPECTED_CHANNELS: string[] = [
  ...
  'LLM_Connection:test',
  'admin:acceptOrganizationJoin',
  'admin:cancelOrganizationInvitation',
  'admin:completeCreatorSkillUpload',
  'admin:createCreatorArtifact',
  'admin:createCreatorArtifactVersion',
  'admin:createCreatorSkillUploadGrant',
  'admin:createOrganization',
  'admin:createOrganizationInvitation',
  'admin:createOrganizationJoinLink',
  'admin:deleteCreatorArtifactDraft',
  'admin:deleteCreatorArtifactVersionDraft',
  'admin:getAuthConfig',
  'admin:getCreatorArtifact',
  'admin:getCreatorArtifactCapabilities',
  'admin:getCreatorSkillDownloadGrant',
  'admin:getCreatorSkillSafetyStatus',
  'admin:getPhoneAuthChallengeConfig',
  'admin:getStatus',
  'admin:listCreatorArtifacts',
  'admin:listOrganizationInvitations',
  'admin:listOrganizationMembers',
  'admin:listOrganizations',
  'admin:listProductSpaces',
  'admin:login',
  'admin:logout',
  ...
  'admin:revokeOrganizationJoinLink',
  'admin:sendPhoneAuthCode',
  'admin:setCreatorArtifactArchived',
  'admin:setPassword',
  'admin:syncAppCatalog',
  'admin:syncConnections',
  'admin:updateOrganizationMember',
  'admin:validate',
  'admin:verifyPhoneAuthCode',
  ...
  'copilot:logout',
  'copilot:startOAuth',
  'creatorSkills:cancel',
  'creatorSkills:deleteBackups',
  'creatorSkills:getTarget',
  'creatorSkills:ignoreVersion',
  'creatorSkills:install',
  'creatorSkills:listBackups',
  'creatorSkills:progress',
  'creatorSkills:uninstall',
  'creatorSkills:updateSafetyStatus',
  ...
  'labels:delete',
  'labels:list',
  'local-apps:cancelInstall',
  'local-apps:getHostInfo',
  ...
  'local-apps:install',
  'local-apps:installProductSpaceBundle',
  ...
  'local-apps:uninstallProductSpaceBundle',
  'logo:getUrl',
  'menu:copy',
  'menu:cut',
  ...
  'power:getKeepAwake',
  'power:setKeepAwake',
  'preferences:getHomeQuickAccess',
  'preferences:getHomeRecentApps',
  'preferences:getOrganizationContextStorage',
  'preferences:getProductSpaceContextStorage',
  'preferences:read',
  'preferences:setHomeQuickAccess',
  'preferences:setHomeRecentApps',
  'preferences:updateOrganizationContextStorage',
  'preferences:updateProductSpaceContextStorage',
  'preferences:write',
  'product-space:cancelSwitch',
  'product-space:catalog',
  'product-space:cleanupLegacyState',
  'product-space:commitSwitch',
  'product-space:getRestrictionState',
  'product-space:list',
  'product-space:listActiveExecutions',
  'product-space:prepareSwitch',
  'product-space:resolveLaunch',
  'product-space:restoreOfflineView',
  'product-space:restrictActiveSpace',
  'product-space:revokeActiveContext',
  'product-space:stopAllExecutions',
  'product-space:stopExecution',
  ...
  'sessions:get',
  'sessions:getEditPopoverPendingQuestion',
  'sessions:getFiles',
