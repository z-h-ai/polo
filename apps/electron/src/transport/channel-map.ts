...
export const CHANNEL_MAP = {
  ...
  creatorArtifactCancelUpload: invoke(RPC_CHANNELS.admin.CANCEL_CREATOR_SKILL_UPLOAD),
  creatorArtifactUploadArchive: invoke(RPC_CHANNELS.admin.UPLOAD_CREATOR_SKILL_ARCHIVE),
