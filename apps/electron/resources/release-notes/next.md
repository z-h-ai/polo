...
- **Local App Bundle runtime** — Install checksum-verified static, Python, and Bun app bundles into isolated version directories, launch them with a minimal credential-free environment, wait for localhost health checks before launch, manage logs and process trees, and preserve user data across updates and last-known-good rollback. (POO-12)
