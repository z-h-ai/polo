...
echo "=== Building Polo AI AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Polo-AI-x86_64.AppImage or Polo-AI-aarch64.AppImage
BUILT_APPIMAGE_NAME="Polo-AI-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Polo-AI-x64.AppImage, Polo-AI-arm64.AppImage
APPIMAGE_NAME="Polo-AI-${ARCH}.AppImage"
