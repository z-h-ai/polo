...
//   - homeDir                /Users/polo           (window.electronAPI.getHomeDir)
//   - customPath             /Users/polo/projects  (directory picker result)
...
//   - server listing         /Users/polo with 6 entries, truncated 6/42,
...
export function SourceWorkspaceCreateNewStep() {
  ...
  // /Users/polo/projects → finalPath ~/projects/polo-app, canCreate true.
  return <section data-route="workspace-creation/create" style={container}>
    ...
    <div style={{ display: 'grid', width: '100%', gap: 22.5, marginTop: 22.5 }}>
      ...
      <div style={{ display: 'grid', gap: 11.25 }}>
        ...
        <RadioOption checked title="选择位置" subtitle="/Users/polo/projects" action={<button type="button" style={secondaryButton}>浏览</button>} />
      </div>
...
export function SourceWorkspaceOpenFolderStep() {
  // Fixture: selectedPath /Users/polo/projects/polaris-app (folder already
  ...
  return <section data-route="workspace-creation/open-folder" style={container}>
    ...
    <div style={{ display: 'grid', width: '100%', gap: 22.5, marginTop: 22.5 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 15, padding: 15, borderRadius: 10, border: '1px solid color-mix(in srgb, var(--border) 50%, transparent)', background: 'var(--background)' }}>
        <div style={{ flex: 1, minWidth: 0 }}><p style={{ margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', fontSize: 13.125 }}>/Users/polo/projects/polaris-app</p></div>
...
// fixture (currentPath /Users/polo, 6 entries of 42, one symlink). Dialog
...
export function SourceServerDirectoryBrowser() {
  const crumbs = [
    { path: '/', name: '/' }, { path: '/Users', name: 'Users' }, { path: '/Users/polo', name: 'polo' } ]
  const entries = [
    { path: '/Users/polo/projects', name: 'projects', isSymlink: false },
    { path: '/Users/polo/code', name: 'code', isSymlink: false },
    { path: '/Users/polo/documents', name: 'documents', isSymlink: false },
    { path: '/Users/polo/shared-notes', name: 'shared-notes', isSymlink: true },
    { path: '/Users/polo/notebooks', name: 'notebooks', isSymlink: false },
    { path: '/Users/polo/source', name: 'source', isSymlink: false },
  ]
    ...
    <section role="dialog" aria-modal="true" aria-labelledby="sdb-title" style={{ position: 'relative', display: 'grid', width: 'min(512px, calc(100% - 32px))', gap: 15, boxSizing: 'border-box', padding: 22.5, borderRadius: 8, background: 'var(--background)', color: 'var(--foreground)', boxShadow: 'var(--shadow-modal-small)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 7.5 }}>
        ...
        <div style={{ display: 'flex', gap: 7.5 }}>
          <input value="/Users/polo" readOnly placeholder="输入路径..." style={{ ...inputField, flex: 1, minWidth: 0, border: `1px solid ${fg15}` }} />
