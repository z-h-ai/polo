...
// (dialog.reset.*). The Renderer chooses operands in the 10..59 range. This
// SOT uses one named deterministic fixture in that range so exports are
// byte-idempotent and the interaction remains representative.
const resetProblemFixture = { a: 17, b: 25, sum: 42 }

export function SourceResetConfirmation() {
  const [answer, setAnswer] = useState('')
  const problem = resetProblemFixture
