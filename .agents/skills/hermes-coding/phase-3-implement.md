<!-- Phase 3 | Tools: Read, Write, Bash, spawn_agent, Grep, Glob | Interactive: no -->
...
```bash
source .agents/skills/hermes-coding/bootstrap-cli.sh
...
Tool: spawn_agent
Parameters:
  task_name: "Run and fix baseline tests"
  fork_turns: "none"
  message: |
...
Tool: spawn_agent
Parameters:
  task_name: "Implement task: {TASK_ID}"
  fork_turns: "none"
  message: |
...
Tool: spawn_agent
Parameters:
  task_name: "Promote learnings for failed task: {TASK_ID}"
  fork_turns: "none"
  message: |
    Read .agents/skills/hermes-coding/promote-progress.md and follow the instructions.
...
Tool: spawn_agent
Parameters:
  task_name: "Fix regression for task: {TASK_ID}"
  fork_turns: "none"
  message: |
...
Tool: spawn_agent
Parameters:
  task_name: "Verify task acceptance criteria: {TASK_ID}"
  fork_turns: "none"
  message: |
...
Tool: spawn_agent
Parameters:
  task_name: "Promote learnings for completed task: {TASK_ID}"
  fork_turns: "none"
  message: |
    Read .agents/skills/hermes-coding/promote-progress.md and follow the instructions.
    TASK_ID: {TASK_ID} | MODULE: {MODULE}
