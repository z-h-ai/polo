...
/**
 * Convert SdkMcpServerConfig (used by backend types) to PoloMcpClient config.
 */
...
export class McpClientPool {
  ...
  protected async registerClient(slug: string, client: PoolClient): Promise<void> {
    // listTools() triggers connect() internally for both PoloMcpClient and ApiSourcePoolClient
