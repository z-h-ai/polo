 ...
 * Default location: ~/.polo-ai/workspaces/
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.polo-ai/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.polo-ai/workspaces/
 */
...
export function isLocalMcpEnabled(rootPath: string): boolean {
  ...
  const envValue = process.env.POLO_AI_LOCAL_MCP_ENABLED;
