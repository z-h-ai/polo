...
export type CreatorArtifactVersionStatus = 'upload_pending' | 'uploaded' | 'validating' | 'validation_failed' | 'validated' | 'published' | 'revoked' | 'expired';
...
export type CreatorSkillOperationStage = 'download' | 'validate' | 'prepare' | 'commit' | 'refresh';
...
export type CreatorSkillInstallConflict = 'workspace_skill' | 'global_skill' | 'different_artifact' | 'local_changes';
...
export type CreatorSkillBackupOperation = 'modified_update' | 'update_safety_snapshot' | 'clean_uninstall_snapshot' | 'concurrent_recreation';
