...
export const RPC_CHANNELS = {
  ...
  sessions: {
    ...
    CREATE_EDIT_POPOVER_SESSION: 'sessions:createEditPopoverSession',
    ...
    COMPLETE_EXTERNAL_ENGINE_TURN: 'sessions:completeExternalEngineTurn',
    CREATE_EXTERNAL_ENGINE_SESSION: 'sessions:createExternalEngineSession',
    GET_EDIT_POPOVER_PENDING_QUESTION: 'sessions:getEditPopoverPendingQuestion',
  ...
  admin: {
    ...
    LIST_ORGANIZATION_MEMBERS: 'admin:listOrganizationMembers',
    LIST_ORGANIZATION_INVITATIONS: 'admin:listOrganizationInvitations',
    CREATE_ORGANIZATION_INVITATION: 'admin:createOrganizationInvitation',
    CANCEL_ORGANIZATION_INVITATION: 'admin:cancelOrganizationInvitation',
    CREATE_ORGANIZATION_JOIN_LINK: 'admin:createOrganizationJoinLink',
    REVOKE_ORGANIZATION_JOIN_LINK: 'admin:revokeOrganizationJoinLink',
    UPDATE_ORGANIZATION_MEMBER: 'admin:updateOrganizationMember',
    REMOVE_ORGANIZATION_MEMBER: 'admin:removeOrganizationMember',
    GET_CREATOR_ARTIFACT_CAPABILITIES: 'admin:getCreatorArtifactCapabilities',
    LIST_CREATOR_ARTIFACTS: 'admin:listCreatorArtifacts',
    GET_CREATOR_ARTIFACT: 'admin:getCreatorArtifact',
    CREATE_CREATOR_ARTIFACT: 'admin:createCreatorArtifact',
    DELETE_CREATOR_ARTIFACT_DRAFT: 'admin:deleteCreatorArtifactDraft',
    CREATE_CREATOR_ARTIFACT_VERSION: 'admin:createCreatorArtifactVersion',
    CREATE_CREATOR_SKILL_UPLOAD_GRANT: 'admin:createCreatorSkillUploadGrant',
    COMPLETE_CREATOR_SKILL_UPLOAD: 'admin:completeCreatorSkillUpload',
    PUBLISH_CREATOR_ARTIFACT_VERSION: 'admin:publishCreatorArtifactVersion',
    DELETE_CREATOR_ARTIFACT_VERSION_DRAFT: 'admin:deleteCreatorArtifactVersionDraft',
    SET_CREATOR_ARTIFACT_ARCHIVED: 'admin:setCreatorArtifactArchived',
  ...
  creatorSkills: {
    GET_TARGET: 'creatorSkills:getTarget',
    INSTALL: 'creatorSkills:install',
    CANCEL: 'creatorSkills:cancel',
    UNINSTALL: 'creatorSkills:uninstall',
    LIST_BACKUPS: 'creatorSkills:listBackups',
    DELETE_BACKUPS: 'creatorSkills:deleteBackups',
    UPDATE_SAFETY_STATUS: 'creatorSkills:updateSafetyStatus',
    IGNORE_VERSION: 'creatorSkills:ignoreVersion',
    PROGRESS: 'creatorSkills:progress',
  },
  statuses: {
    LIST: 'statuses:list',
