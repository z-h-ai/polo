 ...
 *
 * Watched paths:
 * - ~/.polo-ai/config.json - Main app configuration
 * - ~/.polo-ai/preferences.json - User preferences
 * - ~/.polo-ai/theme.json - App-level theme overrides
 * - ~/.polo-ai/themes/*.json - Preset theme files (app-level)
 * - ~/.polo-ai/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.polo-ai/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.polo-ai/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.polo-ai/permissions/)
